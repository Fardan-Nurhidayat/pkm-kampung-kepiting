...
<nav role="navigation" aria-label="Pagination Navigation"
  ...
  <div class="flex justify-center gap-2 flex-1 sm:hidden">
    ...
    <a href="{{ $paginator->previousPageUrl() }}" aria-label="{{ __('pagination.previous') }}"
      class="relative inline-flex items-center px-3 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-md hover:text-gray-800 hover:bg-gray-50 transition">
      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        <path fill-rule="evenodd"
          d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z"
          clip-rule="evenodd" />
