<div>
  ...
  <section class="max-w-screen-2xl mx-auto px-4 py-16">
    ...
    {{-- Loading State --}}
    <div wire:loading.delay wire:target="searchQuery,selectedCategory,sortBy,page"
      class="w-full mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
      @for($i = 0; $i < 6; $i++) <div class="bg-white rounded-2xl shadow-lg overflow-hidden animate-pulse mb-5">
...
{{-- Blog Grid --}}
<div wire:loading.remove wire:target="searchQuery,selectedCategory,sortBy,page"
...
{{-- Pagination --}}
<div class="mt-8" wire:loading.remove wire:target="searchQuery,selectedCategory,sortBy,page">
