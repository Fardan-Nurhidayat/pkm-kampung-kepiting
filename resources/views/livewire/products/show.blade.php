<div>
  ...
  <section class="max-w-4xl mx-auto px-4 py-12">
    ...
    <div class="mt-8 pt-6 border-t border-gray-200">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <button wire:click="toggleLike" class="flex items-center gap-2 px-4 py-2 rounded-full font-semibold transition-all
                        {{ $userHasLiked ? 'bg-primary text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5
                            2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09
    ...
    <div class="mt-12 pt-8 border-t border-gray-200">
      ...
      <div class="flex gap-3">
        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full font-medium transition-all flex items-center
    gap-2">
  ...
  class="inline-flex items-center gap-2 bg-third hover:bg-opacity-90 text-white px-6 py-3 rounded-full font-semibold
  transition-all">
