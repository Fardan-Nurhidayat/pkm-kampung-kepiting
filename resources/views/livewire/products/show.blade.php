...
<button wire:click="submitReview" class="bg-primary hover:bg-primaryDark text-white px-4 py-2 rounded font-semibold">
    Kirim Review
</button>
@else
<a href="{{ route('login') }}"
...
class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full font-medium transition-all flex items-center
gap-2">
