...
<div>
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-sm text-center text-text leading-5 max-w">
            Atau
            <a href="{{ route('register') }}" class="font-medium text-primary hover:text-primaryLight focus:outline-none focus:underline transition ease-in-out duration-150">
                buat akun baru
            </a>
        </p>
        @endif
            ...
            <form wire:submit.prevent="authenticate">
                ...
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="block ml-2 text-sm text-third leading-5">
                            Ingat saya
                        </label>
                    </div>

                    <div class="text-sm leading-5">
                        <a href="{{ route('password.request') }}" class="font-medium text-primary hover:text-primaryLight focus:outline-none focus:underline transition ease-in-out duration-150">
                            Lupa kata sandi?
                        </a>
                    </div>
                </div>
