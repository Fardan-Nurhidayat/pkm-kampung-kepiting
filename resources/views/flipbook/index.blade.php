...
<head>
	<title>PETUALANGAN SI PIKU RAHASIA DI KAMPOENG KEPITING</title>
	...
	<meta property="og:title" content="PETUALANGAN SI PIKU RAHASIA DI KAMPOENG KEPITING" />
	<meta property="og:type" content="article" />
	<meta property="og:url" content="" />
	<meta property="og:description" content="" />
	<meta itemprop="name" content="PETUALANGAN SI PIKU RAHASIA DI KAMPOENG KEPITING">
	<meta itemprop="description" content="">
	<meta itemprop="image" content="./files/shot.jpg">
	<meta name="twitter:site" content="@FlipHTML5">
	<meta name="twitter:title" content="PETUALANGAN SI PIKU RAHASIA DI KAMPOENG KEPITING">
	<meta name="twitter:description" content="">
	<meta name="twitter:image" content="./files/shot.jpg">
	<meta name="twitter:card" content="summary_large_image">

	<base href="{{ asset('flipbook') }}/">
...
<body>
	...
	<script type="text/javascript" src="javascript/jquery-4.0.0.min.js"></script>
	...
	(function() {
		var dynamicLoading = {
			load: function(path, callback, onFailed) {
				...
				function onLoad() {
					loadedCount++;
					if (loadedCount === totalCount && hasCallback) {
						callback();
					}
				}
		...
		dynamicLoading.load('javascript/Browser.js', function() {
			if (typeof isPhone !== 'undefined' && typeof isPad !== 'undefined') {
				if (isPhone() || isPad()) {
					dynamicLoading.load([
						'javascript/main.phone.min.js',
						'style/style.phone.css'
					], function() {
